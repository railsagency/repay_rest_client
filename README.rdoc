...
* you must have the following environment variables set:
  * REPAY_API_TOKEN
  * REPAY_REST_BASE
  * REPAY_SAVE_ACH_TOKEN
  * REPAY_USE_STORED_ACH_TOKEN
  
* result should just be a string containing the ach_token returned from the API
...
result will be a ruby hash parsed from JSON similar to this:
```ruby
  {"auth_code"=>"DEMO323",
   "details"=>nil,
